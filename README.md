...
The data size is 60 GB, so we used Spark and Spark SQL to analyze the data. We also trained a ML classifer to predict when customers adds an item to the cart if they are likely to buy the item or not. The ML classifer was trained using Spark ML.
